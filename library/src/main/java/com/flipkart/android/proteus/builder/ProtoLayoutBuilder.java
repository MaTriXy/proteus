 ...
 */
public interface ProtoLayoutBuilder {

    /**
     * Register {@link ProtoLayoutHandler}s for custom view types.
     *
     * @param type    The name of the view type.
     * @param handler The {@link ProtoLayoutHandler} to use while building this view type.
     */
    void registerHandler(String type, ProtoLayoutHandler handler);

    /**
     * Un-Register the {@link ProtoLayoutHandler} registered using {@link ProtoLayoutBuilder#registerHandler}.
     *
     * @param type remove {@link ProtoLayoutHandler} for the specified view type.
     */
    void unregisterHandler(String type);

    /**
     * Returns the {@link ProtoLayoutHandler} for the specified view type.
     *
     * @param type The name of the view type.
     * @return The {@link ProtoLayoutHandler} associated to the specified view type
     */
    ProtoLayoutHandler getHandler(String type);
     ...
     *
     * @param handler
     * @param view    The view to handle the attributes on.
     * @return true if the attributes is processed false otherwise.
     */
    boolean handleAttribute(ProtoLayoutHandler handler, ProteusView view, Attribute attributes);
    ...
    /**
     * @return The callback object used by this {@link ProtoLayoutBuilder}
     */
    ProtoLayoutBuilderCallback getListener();
     ...
     */
    void setListener(ProtoLayoutBuilderCallback listener);
     ...
     * set the {@link BitmapLoader} for the
     * {@link ProtoLayoutBuilder}
     *
     * @param bitmapLoader {@link BitmapLoader} to use for
     *                     loading images.
     */
    void setBitmapLoader(BitmapLoader bitmapLoader);

    /**
     * @return true when rendering preview immediately by this {@link ProtoLayoutBuilder} synchronously
     * otherwise false.
     */
